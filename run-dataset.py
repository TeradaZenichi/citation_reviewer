...
#shuffle papers random using seed 42
import random
random.seed(32)
random.shuffle(papers)

#get the first 5 accepted papers and the first 5 rejected papers
papers = [paper for paper in papers if paper["status"] == "accepted"][:25] + [paper for paper in papers if paper["status"] == "rejected"][:25]
